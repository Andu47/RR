...
public class AutonomBlueDuck extends LinearOpMode {
    DcMotor Brat;
    DcMotor Intake;
    DcMotor FataSt;
    DcMotor SpateSt;
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            Pose2d leftP = new Pose2d(0,15.5,0);
            Pose2d langaCaruselP = new Pose2d(36.5,15.5, 4.68);
            Pose2d toCaruselP = new Pose2d(36.5,13.5,4.68);
            Pose2d catreShippingP = new Pose2d(25.6,40.5,4.68);
            Pose2d toShippingP = new Pose2d(3.5,42.5,0);
            Pose2d parkP = new Pose2d(33.8, 25., 0);

            drive.setPoseEstimate(startPose);

            Trajectory stanga = drive.trajectoryBuilder(startPose)
                    .lineToLinearHeading(leftP)
                    .build();
            Trajectory langaCarusel = drive.trajectoryBuilder(leftP)
                    .lineToLinearHeading(langaCaruselP)
                    .build();
            Trajectory toCarusel = drive.trajectoryBuilder(langaCaruselP)
                    .lineToLinearHeading(toCaruselP)
                    .build();
            Trajectory langaCarusel1 = drive.trajectoryBuilder(toCaruselP)
                    .lineToLinearHeading(langaCaruselP)
                    .build();
            Trajectory catreShipping = drive.trajectoryBuilder(toCaruselP)
                    .lineToLinearHeading(catreShippingP)
                    .build();
            Trajectory toShipping = drive.trajectoryBuilder(catreShippingP)
                    .lineToLinearHeading(toShippingP, SampleMecanumDrive.getVelocityConstraint(10, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                    .build();
            Trajectory park = drive.trajectoryBuilder(toShippingP)
                    .lineToLinearHeading(parkP)
                    .build();

            drive.followTrajectory(stanga);
            drive.followTrajectory(langaCarusel);
            drive.followTrajectory(toCarusel);
            Carusel.setPower(0.4);
            sleep(5000);
            drive.followTrajectory(langaCarusel1);
            drive.followTrajectory(catreShipping);
