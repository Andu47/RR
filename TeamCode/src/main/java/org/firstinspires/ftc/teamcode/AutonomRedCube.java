...
@Autonomous (name= "RedCube")

public class AutonomRedCube extends LinearOpMode {
    DcMotor Brat;
    DcMotor Intake;
    DcMotor FataSt;
    DcMotor SpateSt;
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            Pose2d shippingPose = new Pose2d(-5.2, 25.5 , 5.3);
            Pose2d colorSensPose = new Pose2d(30, 0, 0);

            drive.setPoseEstimate(startPose);

            Trajectory fromStartToShip = drive.trajectoryBuilder(startPose)
            ...
            Trajectory spate = drive.trajectoryBuilder(new Pose2d(0,0,0))
                    .back(5)
                    .build();
            if(pozitie<600 && pozitie>10)//mijloc
            {
            ...
            for(int i=0; i<=1; i++)
            {
                ...
                while(culPos.alpha()<250)
                {
                    ...
                    drive.setMotorPowers(-0.2,-0.3,-0.2,-0.3);
                }
                drive.setMotorPowers(0,0,0,0);
